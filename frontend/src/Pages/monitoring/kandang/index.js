...
export default function KandangPage() {
    ...
    useEffect(() => {
        ...
        if (token) {
            axios
                .get(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/kandang?email=${storedEmail}`, {
                    headers: {
    ...
    return (
        <div className="flex flex-col md:flex-row bg-white h-auto min-h-svh">
            ...
            <div className="md:ml-64 mt-10 container mx-auto p-4">
                ...
                {/* tombol tambah data */}
                <Link href="/monitoring/form/Inisiasi" 
                    className="absolute right-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Inisiasi Kandang
                </Link>
